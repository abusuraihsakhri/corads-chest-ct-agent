"""
Automated Pytest for corads-chest-ct-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    AipoweredPulmonaryEmbolismSegmentationAgent,
    MultivariantRespiratoryVirusDifferentialDiagnosisAgent,
...
def test_enrichment_suite_execution():
    suite = CoradschestctagentEnrichmentSuite()
